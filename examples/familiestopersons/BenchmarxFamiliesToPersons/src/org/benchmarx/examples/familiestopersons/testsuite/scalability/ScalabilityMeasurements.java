...
import org.benchmarx.examples.familiestopersons.implementations.rtl.RtlFamiliesToPersons;
...
//	private static final NMFFamiliesToPersonsIncremental tool6 = new NMFFamiliesToPersonsIncremental();
	private static final BXTool<FamilyRegister, PersonRegister, Decisions> tool7 = new RtlFamiliesToPersons();
...
//	private BXToolTimer<FamilyRegister, PersonRegister, Decisions> timer6;
	private BXToolTimer<FamilyRegister, PersonRegister, Decisions> timer7;
...
//		timer6 = new NMFFamiliesToPersonsTimer(tool6, repeat);
		timer7 = new BXToolTimer<>(tool7, repeat);
	}
...
//		System.out.print(timer6.timeSourceEditFromScratchInS(this::createFamiliesWithMembers) + UNIT);
		System.out.print(timer7.timeSourceEditFromScratchInS(this::createFamiliesWithMembers) + UNIT);
		System.out.println();
	}
...
//		System.out.print(timer6.timeTargetEditFromScratchInS(this::createPersons) + UNIT);
		System.out.print(timer7.timeTargetEditFromScratchInS(this::createPersons) + UNIT);
		System.out.println();
	}
...
//		System.out.print(timer6.timeSourceEditAfterSetUpInS(this::createFamiliesWithMembers, this::createOneFamilyMember) + UNIT);
		System.out.print(timer7.timeSourceEditAfterSetUpInS(this::createFamiliesWithMembers, this::createOneFamilyMember) + UNIT);
		System.out.println();
	}
...
//		System.out.print(timer6.timeTargetEditAfterSetUpInS(this::createPersons, this::createOnePerson) + UNIT);
		System.out.print(timer7.timeTargetEditAfterSetUpInS(this::createPersons, this::createOnePerson) + UNIT);
		System.out.println();
	}
